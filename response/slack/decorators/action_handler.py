...
class ActionContext:
    def __init__(self, incident, user_id, message, button_value, trigger_id, response_url):
...
def handle_action(payload):
    ...
    if actions:
        ...
        try:
            ...
            logger.error(f"Can't find incident associated with channel {channel_id} or with id {incident_id}")
            return
